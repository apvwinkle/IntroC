...
// Program 6B : Using Files, Arrays, and Structures 
...

{
	...
	do
	{
		...
		case 'Q':
		case 'q': cout << "Are you sure you want to quit? All unsaved data will be lost.";
...
void displayscores()
{
	...
	if (numStudents < 1)
	{
		...
		cout << "\n You may need to input scores. Press K or R on the main menu." << endl;
	}
	else
	{
		cout << setprecision(3);
		...
		for (int i = 0; i < numStudents; i++)
		{
			cout << studentRecord[i].firstname << "\t \t" << studentRecord[i].lastname << "\t \t" << studentRecord[i].score << endl;
		}
		cout << endl;
